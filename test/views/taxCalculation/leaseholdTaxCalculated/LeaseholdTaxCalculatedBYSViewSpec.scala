...
class LeaseholdTaxCalculatedBYSViewSpec extends SpecBase {

  "LeaseholdTaxCalculatedBYSView" - {
    ...
    "must render the page title and heading" in {
      ...
      running(application) {
        ...
        doc.select("title").first().text() must include(msgs("taxCalculation.beforeStart.title.leasehold.taxCalculated"))
