...
class LeaseNetPresentValueFormProviderSpec extends StringFieldBehaviours {

  ".value" - {

    val requiredKey = "lease.netPresentValue.error.required"
    val invalidNumericKey = "lease.netPresentValue.error.invalidNumeric"
    val invalidWholeNumberKey = "lease.netPresentValue.error.invalidWholeNumber"
    val maxValueKey = "lease.netPresentValue.error.maximum"

    val form = new LeaseNetPresentValueFormProvider()()
