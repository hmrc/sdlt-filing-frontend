...
class LeaseEnterTotalPremiumPayableFormProviderSpec extends StringFieldBehaviours {

  ".value" - {

    val requiredKey = "lease.enterTotalPremiumPayable.error.required"
    val invalidNumericKey = "lease.enterTotalPremiumPayable.error.invalidNumeric"
    val invalidWholeNumberKey = "lease.enterTotalPremiumPayable.error.invalidWholeNumber"
    val maxValueKey = "lease.enterTotalPremiumPayable.error.maximum"

    val form = new LeaseEnterTotalPremiumPayableFormProvider()()
