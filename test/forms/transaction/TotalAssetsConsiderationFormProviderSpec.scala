...
class TotalAssetsConsiderationFormProviderSpec extends StringFieldBehaviours {

  val requiredKey = "transaction.totalAssetsConsideration.error.required"
  val invalidNumericKey = "transaction.totalAssetsConsideration.error.invalidNumeric"
  val invalidWholeNumberKey = "transaction.totalAssetsConsideration.error.invalidWholeNumber"
  val maxValueKey = "transaction.totalAssetsConsideration.error.maximum"

  val form = new TotalAssetsConsiderationFormProvider()()
