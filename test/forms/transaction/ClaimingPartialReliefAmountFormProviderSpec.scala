...
class ClaimingPartialReliefAmountFormProviderSpec extends StringFieldBehaviours {

  val requiredKey = "transaction.claimingPartialReliefAmount.error.required"
  val invalidNumericKey = "transaction.claimingPartialReliefAmount.error.invalidNumeric"
  val invalidWholeNumberKey = "transaction.claimingPartialReliefAmount.error.invalidWholeNumber"
  val maxValueKey = "transaction.claimingPartialReliefAmount.error.maximum"

  val form = new ClaimingPartialReliefAmountFormProvider()()
