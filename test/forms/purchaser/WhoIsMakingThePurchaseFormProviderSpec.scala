...
class WhoIsMakingThePurchaseFormProviderSpec extends OptionFieldBehaviours {

  val form = new WhoIsMakingThePurchaseFormProvider()()
  ...
  ".value" - {
    ...
    behave like optionsField[WhoIsMakingThePurchase](
      form,
      fieldName,
      validValues = WhoIsMakingThePurchase.values,
