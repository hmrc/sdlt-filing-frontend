...
class TaxDueOnNpvFormProviderSpec extends StringFieldBehaviours {

  val requiredKey           = "taxCalculation.taxDueOnNpv.error.required"
  val invalidNumericKey     = "taxCalculation.taxDueOnNpv.error.invalidNumeric"
  val invalidWholeNumberKey = "taxCalculation.taxDueOnNpv.error.invalidWholeNumber"
  val maxValueKey           = "taxCalculation.taxDueOnNpv.error.maximum"
  val maxValueLengthKey     = "taxCalculation.taxDueOnNpv.error.length"

  val form = new TaxDueOnNpvFormProvider()()
