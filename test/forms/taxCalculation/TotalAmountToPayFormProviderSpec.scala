...
class TotalAmountToPayFormProviderSpec extends StringFieldBehaviours {

  val requiredKey = "taxCalculation.totalAmountDue.totalAmountToPay.error.required"
  val invalidNumericKey = "taxCalculation.totalAmountDue.totalAmountToPay.error.invalidNumeric"
  val invalidWholeNumberKey = "taxCalculation.totalAmountDue.totalAmountToPay.error.invalidWholeNumber"
  val maxValueKey = "taxCalculation.totalAmountDue.totalAmountToPay.error.maximum"
  val maximumLengthKey = "taxCalculation.totalAmountDue.totalAmountToPay.error.length"

  val form = new TotalAmountToPayFormProvider()()
