...
class LeaseholdSelfAssessedPagesSpec extends SpecBase {

  private val pages: Seq[(QuestionPage[Boolean], String)] = Seq(
    LeaseholdSelfAssessedPremiumPayableTaxPage    -> "leaseholdSelfAssessedPremiumPayableTax",
    LeaseholdSelfAssessedNpvTaxPage               -> "leaseholdSelfAssessedNpvTax",
    LeaseholdSelfAssessedTotalAmountDuePage       -> "leaseholdSelfAssessedTotalAmountDue",
    LeaseholdSelfAssessedPenaltiesAndInterestPage -> "leaseholdSelfAssessedPenaltiesAndInterest"
  )

  "Leasehold self-assessed pages" - {
