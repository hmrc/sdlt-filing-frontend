...
class PurchaserPartnershipUtrSummarySpec extends SpecBase {

  "PurchaserPartnershipUtrSummary" - {

    "when UTR number is present" - {
      ...
      "must return a summary list row with ID number and country issued" in {
        ...
        running(application) {
          ...
          val userAnswers = emptyUserAnswers
            .set(PurchaserPartnershipUtrPage, "1234567890").success.value
