...
class LeaseholdTaxCalculatedDoesAmountIncludePenaltiesSummarySpec extends SpecBase {

  "LeaseholdSelfAssessedDoesAmountIncludePenaltiesSummary" - {
    ...
    "LeaseholdTaxCalculatedPenaltiesAndInterestPage :: must return a SummaryListRow with change link" in {
      ...
      running(application) {
        ...
        val row = LeaseholdTaxCalculatedDoesAmountIncludePenaltiesSummary.row(Some(userAnswers))
