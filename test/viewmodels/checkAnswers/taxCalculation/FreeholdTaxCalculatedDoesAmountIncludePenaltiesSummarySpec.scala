...
class FreeholdTaxCalculatedDoesAmountIncludePenaltiesSummarySpec extends SpecBase {

  "FreeholdTaxCalculatedDoesAmountIncludePenaltiesSummary" - {

    "FreeholdTaxCalculatedPenaltiesAndInterestPage :: must return a SummaryListRow with change link" in {
      ...
      running(application) {
        ...
        val row = FreeholdTaxCalculatedDoesAmountIncludePenaltiesSummary.row(Some(userAnswers))
