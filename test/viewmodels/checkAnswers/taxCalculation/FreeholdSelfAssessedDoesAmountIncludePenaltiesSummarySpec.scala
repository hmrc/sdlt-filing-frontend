...
class FreeholdSelfAssessedDoesAmountIncludePenaltiesSummarySpec extends SpecBase {

  "FreeholdSelfAssessedDoesAmountIncludePenaltiesSummary" - {
    ...
    "FreeholdSelfAssessedPenaltiesAndInterestPage :: must return a SummaryListRow with change link" in {
      ...
      running(application) {
        ...
        val row = FreeholdSelfAssessedDoesAmountIncludePenaltiesSummary.row(Some(userAnswers))
