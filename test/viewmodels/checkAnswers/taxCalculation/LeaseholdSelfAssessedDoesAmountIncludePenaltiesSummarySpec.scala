...
class LeaseholdSelfAssessedDoesAmountIncludePenaltiesSummarySpec extends SpecBase {
  ...
  "LeaseholdSelfAssessedDoesAmountIncludePenaltiesSummary" - {
    ...
    "LeaseholdSelfAssessedPenaltiesAndInterestPage :: must return a SummaryListRow with change link" in {
      ...
      running(application) {
        ...
        val row = LeaseholdSelfAssessedDoesAmountIncludePenaltiesSummary.row(Some(userAnswers))
