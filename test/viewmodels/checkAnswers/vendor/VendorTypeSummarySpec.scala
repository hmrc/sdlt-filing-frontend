    ...
    "when transaction type is present" - {
      ...
      "must return a summary list row with transaction type value and change link" in {
        ...
        running(application) {
          ...
          val userAnswers = emptyUserAnswers.set(WhoIsTheVendorPage, whoIsTheVendor.Business).success.value
      ...
      "must display the correct message for different transaction types" in {
        ...
        running(application) {
          ...
          individualOrCompany.foreach { transactionType =>
            val userAnswers = emptyUserAnswers
              .set(WhoIsTheVendorPage, whoIsTheVendor.Business).success.value
