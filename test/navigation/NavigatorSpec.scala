  ...
  "Navigator" - {
    ...
    "in Normal mode" - {
      ...
      "freehold tax calculated routes" - {
        ...
        "go from FreeholdTaxCalculatedPenaltiesAndInterestPage to the tax calculation Check Your Answers page" in {
      ...
      "freehold self-assessed routes" - {
        ...
        "go from FreeholdSelfAssessedPenaltiesAndInterestPage to the tax calculation Check Your Answers page" in {
      ...
      "leasehold tax calculated routes" - {
        ...
        "go from LeaseholdTaxCalculatedPenaltiesAndInterestPage to the tax calculation Check Your Answers page" in {
      ...
      "leasehold self-assessed routes" - {
        ...
        "go from LeaseholdSelfAssessedPenaltiesAndInterestPage to the tax calculation Check Your Answers page" in {
