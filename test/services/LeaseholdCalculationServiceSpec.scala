...
class LeaseholdCalculationServiceSpec extends PlaySpec with LeaseholdRequestFeature with LeaseholdResultFixture {
  ...
  "leaseholdMixedNonResMar2008toMar2016" must {
    "return zero tax for premium of 150000 and for npv of 150000" in new PredefinedNPVSetup(predefinedNPV = 150000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(150000), rate = 0, taxDue = 0),
        SliceDetails(from = 150000, to = None,         rate = 1, taxDue = 0)
      )

      private val res = leaseholdMixedNonResMar2008toMar2016Result(
        leaseTaxDue = 0, leaseSliceDetails = leaseSliceDetails,
        premTaxDue = 0, premRate = 0, npv = 150000)
      service.leaseholdMixedNonResMar2008toMar2016(
        leaseholdMixedNonResMar2008toMar2016Request(150000)) shouldBe res
    }
    "return correct tax for premium of 250000 and for npv 300000" in new PredefinedNPVSetup(predefinedNPV = 300000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(150000), rate = 0, taxDue = 0),
      ...
      private val res = leaseholdMixedNonResMar2008toMar2016Result(
        leaseTaxDue = 1500, leaseSliceDetails = leaseSliceDetails,
        premTaxDue = 2500, premRate = 1, npv = 300000)

      service.leaseholdMixedNonResMar2008toMar2016(
        leaseholdMixedNonResMar2008toMar2016Request(250000)) shouldBe res
    }
    "return correct tax for premium of 500000 and for npv 300000" in new PredefinedNPVSetup(predefinedNPV = 300000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(150000), rate = 0, taxDue = 0),
        SliceDetails(from = 150000, to = None,         rate = 1, taxDue = 1500)
      )
      ...
      private val res = leaseholdMixedNonResMar2008toMar2016Result(
        leaseTaxDue = 1500, leaseSliceDetails = leaseSliceDetails,
        premTaxDue = 15000, premRate = 3, npv = 300000)

      service.leaseholdMixedNonResMar2008toMar2016(
        leaseholdMixedNonResMar2008toMar2016Request(500000)) shouldBe res
    }
    "return correct tax for premium of 1000000 and for npv 300000" in new PredefinedNPVSetup(predefinedNPV = 300000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(150000), rate = 0, taxDue = 0),
        SliceDetails(from = 150000, to = None,         rate = 1, taxDue = 1500)
      )
      ...
      private val res = leaseholdMixedNonResMar2008toMar2016Result(
        leaseTaxDue = 1500, leaseSliceDetails = leaseSliceDetails,
        premTaxDue = 40000, premRate = 4, npv = 300000)

      service.leaseholdMixedNonResMar2008toMar2016(
        leaseholdMixedNonResMar2008toMar2016Request(1000000)) shouldBe res
    }
  }
  ...
  "leaseholdReliefFrom15PercentRateRightToBuyMixedOnOrAfterMarch2016" must {
    def testRequest(premium: BigDecimal): Request = Request(
      holdingType = HoldingTypes.leasehold,
      propertyType = PropertyTypes.mixed,
    ...
    def expectedResult(leaseTaxDue: Int, leaseSliceDetails: Seq[SliceDetails], premiumSliceDetails:Seq[SliceDetails], premTaxDue: Int, npv: Int): Result =
      Result(
        totalTax = leaseTaxDue + premTaxDue,
        ...
        taxCalcs = Seq(
          ...
          CalculationDetails(
            ...
            taxDue = premTaxDue,
            slices = Some(premiumSliceDetails)
          )
        )
      )

    "return lease taxDue of 0, premium taxDue of 0 for npv of 150000 and premium of 150000" in new PredefinedNPVSetup(150000) {
      val leaseSliceDetails: Seq[SliceDetails] = Seq(
        SliceDetails(from = 0,        to = Some(150000),   rate = 0, taxDue = 0),
        SliceDetails(from = 150000,   to = Some(5000000),  rate = 1, taxDue = 0),
        SliceDetails(from = 5000000,  to = None,           rate = 2, taxDue = 0)
      ...
      val premiumSliceDetails: Seq[SliceDetails] = Seq(
        SliceDetails(from = 0,        to = Some(150000),   rate = 0, taxDue = 0),
        SliceDetails(from = 150000,   to = Some(250000),   rate = 2, taxDue = 0),
        SliceDetails(from = 250000,   to = None,           rate = 5, taxDue = 0)
      )

      service.leaseholdReliefFrom15PercentRateRightToBuyMixedOnOrAfterMarch2016(testRequest(150000)) shouldBe
        expectedResult(leaseTaxDue = 0, leaseSliceDetails = leaseSliceDetails, premiumSliceDetails = premiumSliceDetails, premTaxDue = 0, npv)

    }
    "return lease taxDue of 46809,  premium taxDue of 2000  for npv of 5000000 and premium of 250000" in new PredefinedNPVSetup(4830917) {
      val leaseSliceDetails: Seq[SliceDetails] = Seq(
        SliceDetails(from = 0,        to = Some(150000),   rate = 0, taxDue = 0),
        SliceDetails(from = 150000,   to = Some(5000000),  rate = 1, taxDue = 46809),
        SliceDetails(from = 5000000,  to = None,           rate = 2, taxDue = 0)
      )
      ...
      service.leaseholdReliefFrom15PercentRateRightToBuyMixedOnOrAfterMarch2016(testRequest(250000)) shouldBe
        expectedResult(leaseTaxDue = 46809, leaseSliceDetails = leaseSliceDetails, premiumSliceDetails = premiumSliceDetails, premTaxDue = 2000, npv)

    }
    "return lease taxDue of 64442, premium taxDue of 24500 for npv of 5797101 and premium of 700000" in new PredefinedNPVSetup(5797101) {
      val leaseSliceDetails: Seq[SliceDetails] = Seq(
        SliceDetails(from = 0,        to = Some(150000),   rate = 0, taxDue = 0),
        SliceDetails(from = 150000,   to = Some(5000000),  rate = 1, taxDue = 48500),
        SliceDetails(from = 5000000,  to = None,           rate = 2, taxDue = 15942)
      )

      val premiumSliceDetails: Seq[SliceDetails] = Seq(
        SliceDetails(from = 0,        to = Some(150000),   rate = 0, taxDue = 0),
        SliceDetails(from = 150000,   to = Some(250000),   rate = 2, taxDue = 2000),
        SliceDetails(from = 250000,   to = None,           rate = 5, taxDue = 22500)
      )

      service.leaseholdReliefFrom15PercentRateRightToBuyMixedOnOrAfterMarch2016(testRequest(700000)) shouldBe
        expectedResult(leaseTaxDue = 64442, leaseSliceDetails = leaseSliceDetails, premiumSliceDetails = premiumSliceDetails, premTaxDue = 24500, npv)
  ...
  "leaseholdMixedOrNonResidentialMar16Onwards" must {
    ...
    "return lease taxDue 0, premium taxDue 0 for npv of 150000 and premium of 100000" in new PredefinedNPVSetup(150000) {
      ...
      val premiumSliceDetails = Seq(
        SliceDetails(from = 0,        to = Some(150000),   rate = 0, taxDue = 0),
        SliceDetails(from = 150000,   to = Some(250000),   rate = 2, taxDue = 0),
        SliceDetails(from = 250000,   to = None,           rate = 5, taxDue = 0)
      )
      service.leaseholdMixedOrNonResidentialMar16Onwards(testRequest(100000)) shouldBe
        expectedResult(leaseTaxDue = 0, leaseSliceDetails, premiumSliceDetails = premiumSliceDetails, premTaxDue = 0, npv)
    }

    "return lease taxDue 500, premium taxDue 1000 for npv of 200000 and premium of 200000" in new PredefinedNPVSetup(200000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(150000), rate = 0, taxDue = 0),
        SliceDetails(from = 150000, to = Some(5000000), rate = 1, taxDue = 500),
        SliceDetails(from = 5000000, to = None,         rate = 2, taxDue = 0)
      )
      val premiumSliceDetails = Seq(
        SliceDetails(from = 0,        to = Some(150000),   rate = 0, taxDue = 0),
        SliceDetails(from = 150000,   to = Some(250000),   rate = 2, taxDue = 1000),
        SliceDetails(from = 250000,   to = None,           rate = 5, taxDue = 0)
      )
      service.leaseholdMixedOrNonResidentialMar16Onwards(testRequest(200000)) shouldBe
        expectedResult(leaseTaxDue = 500, leaseSliceDetails, premiumSliceDetails = premiumSliceDetails, premTaxDue = 1000, npv)
    }

    "return lease taxDue 1500, premium taxDue 4500 for npv of 300000 and premium of 300000" in new PredefinedNPVSetup(300000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(150000), rate = 0, taxDue = 0),
        SliceDetails(from = 150000, to = Some(5000000), rate = 1, taxDue = 1500),
        SliceDetails(from = 5000000, to = None,         rate = 2, taxDue = 0)
      )
      val premiumSliceDetails = Seq(
        SliceDetails(from = 0,        to = Some(150000),   rate = 0, taxDue = 0),
        SliceDetails(from = 150000,   to = Some(250000),   rate = 2, taxDue = 2000),
        SliceDetails(from = 250000,   to = None,           rate = 5, taxDue = 2500)
      )
      service.leaseholdMixedOrNonResidentialMar16Onwards(testRequest(300000)) shouldBe
        expectedResult(leaseTaxDue = 1500, leaseSliceDetails, premiumSliceDetails = premiumSliceDetails, premTaxDue = 4500, npv)
    }

    "return lease taxDue 5500, premium taxDue 0 for npv of 6000000 and premium of 6000000" in new PredefinedNPVSetup(6000000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(150000), rate = 0, taxDue = 0),
        SliceDetails(from = 150000, to = Some(5000000), rate = 1, taxDue = 48500),
        SliceDetails(from = 5000000, to = None,         rate = 2, taxDue = 20000)
      )
      val premiumSliceDetails = Seq(
        SliceDetails(from = 0,        to = Some(150000),   rate = 0, taxDue = 0),
        SliceDetails(from = 150000,   to = Some(250000),   rate = 2, taxDue = 2000),
        SliceDetails(from = 250000,   to = None,           rate = 5, taxDue = 287500)
      )
      service.leaseholdMixedOrNonResidentialMar16Onwards(testRequest(6000000)) shouldBe
        expectedResult(leaseTaxDue = 68500, leaseSliceDetails, premiumSliceDetails = premiumSliceDetails, premTaxDue = 289500, npv)
    }
  }

  // SDLT - Tax Calc Case - 32 - Leased
  "leaseholdMixedNonResidentialRightToBuyBeforeMarch08" must {
    def testRequest(premium: BigDecimal): Request = Request(
      holdingType = HoldingTypes.leasehold,
      propertyType = PropertyTypes.mixed,
      effectiveDate = LocalDate.of(2008, 3, 11),
    ...
    "return lease taxDue 0, premium taxDue 0 for npv of 150000 and premium of 150000" in new PredefinedNPVSetup(150000) {
      val leaseSliceDetails: Seq[SliceDetails] = Seq(
        SliceDetails(from = 0, to = Some(150000), rate = 0, taxDue = 0),
        SliceDetails(from = 150000, to = None, rate = 1, taxDue = 0)
      )
      service.leaseholdMixedNonResidentialRightToBuyBeforeMarch08(testRequest(150000)) shouldBe
        expectedResult(leaseTaxDue = 0, leaseSliceDetails, premTaxDue = 0, premRate = 0, npv)
    }
    "return lease taxDue 1000, premium taxDue 2500 for npv of 250000 and premium of 250000" in new PredefinedNPVSetup(250000) {
      val leaseSliceDetails: Seq[SliceDetails] = Seq(
        SliceDetails(from = 0, to = Some(150000), rate = 0, taxDue = 0),
        SliceDetails(from = 150000, to = None, rate = 1, taxDue = 1000)
      )
      service.leaseholdMixedNonResidentialRightToBuyBeforeMarch08(testRequest(250000)) shouldBe
        expectedResult(leaseTaxDue = 1000, leaseSliceDetails, premTaxDue = 2500, premRate = 1, npv)
    }
    "return lease taxDue 3500, premium taxDue 15000 for npv of 500000 and premium of 500000" in new PredefinedNPVSetup(500000) {
      val leaseSliceDetails: Seq[SliceDetails] = Seq(
        SliceDetails(from = 0, to = Some(150000), rate = 0, taxDue = 0),
        SliceDetails(from = 150000, to = None, rate = 1, taxDue = 3500)
      )
      service.leaseholdMixedNonResidentialRightToBuyBeforeMarch08(testRequest(500000)) shouldBe
        expectedResult(leaseTaxDue = 3500, leaseSliceDetails, premTaxDue = 15000, premRate = 3, npv)
    }
    "return lease taxDue 6000, premium taxDue 20000 for npv of 750000 and premium of 750000" in new PredefinedNPVSetup(750000) {
      val leaseSliceDetails: Seq[SliceDetails] = Seq(
        SliceDetails(from = 0, to = Some(150000), rate = 0, taxDue = 0),
        SliceDetails(from = 150000, to = None, rate = 1, taxDue = 6000)
      )
      service.leaseholdMixedNonResidentialRightToBuyBeforeMarch08(testRequest(750000)) shouldBe
        expectedResult(leaseTaxDue = 6000, leaseSliceDetails, premTaxDue = 30000, premRate = 4, npv)
    }
  }

  //SDLT - Tax Calc Case - Case 58
  "leaseHoldResidentialFirstTimeBuyerReliefAfterNov2017AndBeforeJul20" must {
    def testRequest(premium: BigDecimal): Request = Request(
      holdingType = HoldingTypes.leasehold,
      ...
      premium = premium,
      highestRent = 0,
      propertyDetails = Some(PropertyDetails(individual = true,
        twoOrMoreProperties = Some(false),
        replaceMainResidence = None,
        sharedOwnership = None,
        currentValue = None)),
    ...
    "return lease taxDue 0, premium taxDue 0 for npv of 150000 and premium of 100000" in new PredefinedNPVSetup(100000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(125000), rate = 0, taxDue = 0),
        SliceDetails(from = 125000, to = None,         rate = 1, taxDue = 0)
      )
      ...
      service.leaseHoldResidentialFirstTimeBuyerReliefAfterNov2017AndBeforeJul20(testRequest(100000)) shouldBe
        expectedResult(leaseTaxDue = 0, leaseSliceDetails, premiumSliceDetails, premTaxDue = 0, npv)
    }

    "return lease taxDue 250, premium taxDue 1500 for npv of 150000 and premium of 200000" in new PredefinedNPVSetup(150000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(125000), rate = 0, taxDue = 0),
        SliceDetails(from = 125000, to = None,         rate = 1, taxDue = 250)
      )

      val premiumSliceDetails = Seq(
        SliceDetails(from = 0,        to = Some(125000),   rate = 0, taxDue = 0),
        SliceDetails(from = 125000,   to = Some(250000),   rate = 2, taxDue = 1500),
        SliceDetails(from = 250000,   to = Some(925000),   rate = 5, taxDue = 0),
        SliceDetails(from = 925000,   to = Some(1500000),  rate = 10, taxDue = 0),
        SliceDetails(from = 1500000,  to = None,           rate = 12, taxDue = 0)
      )
      service.leaseHoldResidentialFirstTimeBuyerReliefAfterNov2017AndBeforeJul20(testRequest(200000)) shouldBe
        expectedResult(leaseTaxDue = 250, leaseSliceDetails, premiumSliceDetails, premTaxDue = 1500, npv)
    }

    "return lease taxDue 750, premium taxDue 15000 for npv of 200000 and premium of 500000" in new PredefinedNPVSetup(200000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(125000), rate = 0, taxDue = 0),
        SliceDetails(from = 125000, to = None,         rate = 1, taxDue = 750)
      )
      ...
      service.leaseHoldResidentialFirstTimeBuyerReliefAfterNov2017AndBeforeJul20(testRequest(500000)) shouldBe
        expectedResult(leaseTaxDue = 750, leaseSliceDetails, premiumSliceDetails, premTaxDue = 15000, npv)
    }

    "return lease taxDue 3750, premium taxDue 43750 for npv of 500000 and premium of 1000000" in new PredefinedNPVSetup(500000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(125000), rate = 0, taxDue = 0),
        SliceDetails(from = 125000, to = None,         rate = 1, taxDue = 3750)
      )
      ...
      val premiumSliceDetails = Seq(
        ...
        SliceDetails(from = 125000,   to = Some(250000),   rate = 2, taxDue = 2500),
        SliceDetails(from = 250000,   to = Some(925000),   rate = 5, taxDue = 33750),
        SliceDetails(from = 925000,   to = Some(1500000),  rate = 10, taxDue = 7500),
        SliceDetails(from = 1500000,  to = None,           rate = 12, taxDue = 0)
      )
      service.leaseHoldResidentialFirstTimeBuyerReliefAfterNov2017AndBeforeJul20(testRequest(1000000)) shouldBe
        expectedResult(leaseTaxDue = 3750, leaseSliceDetails, premiumSliceDetails, premTaxDue = 43750, npv)
    }
    "return lease taxDue 3750, premium taxDue 43750 for npv of 1000000 and premium of 2000000" in new PredefinedNPVSetup(1000000) {
      val leaseSliceDetails = Seq(
        SliceDetails(from = 0,      to = Some(125000), rate = 0, taxDue = 0),
        SliceDetails(from = 125000, to = None,         rate = 1, taxDue = 8750)
      )
      ...
      val premiumSliceDetails = Seq(
        ...
        SliceDetails(from = 250000,   to = Some(925000),   rate = 5, taxDue = 33750),
        SliceDetails(from = 925000,   to = Some(1500000),  rate = 10, taxDue = 57500),
        SliceDetails(from = 1500000,  to = None,           rate = 12, taxDue = 60000)
      )
      service.leaseHoldResidentialFirstTimeBuyerReliefAfterNov2017AndBeforeJul20(testRequest(2000000)) shouldBe
        expectedResult(leaseTaxDue = 8750, leaseSliceDetails, premiumSliceDetails, premTaxDue = 153750, npv)
    }
  }
}
