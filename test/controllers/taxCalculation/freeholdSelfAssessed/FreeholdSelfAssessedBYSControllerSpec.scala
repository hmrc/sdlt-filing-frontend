...
class FreeholdSelfAssessedBYSControllerSpec extends SpecBase {

  "FreeholdSelfAssessedBYS Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, controllers.taxCalculation.freeholdSelfAssessed.routes.FreeholdSelfAssessedBYSController.onPageLoad().url)
