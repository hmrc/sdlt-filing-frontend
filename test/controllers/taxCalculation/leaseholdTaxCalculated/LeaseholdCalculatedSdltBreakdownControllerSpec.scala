  ...
  "LeaseholdCalculatedSdltBreakdownController" - {
    ...
    "must return OK and render the breakdown view when valid user answers given" in {
      ...
      running(app) {
        ...
        val breakdownUrl = controllers.taxCalculation.leaseholdTaxCalculated.routes.LeaseholdCalculatedSdltDueController.onPageLoad().url
        val titleKey     = "taxCalculation.calculation.leasehold.title"
