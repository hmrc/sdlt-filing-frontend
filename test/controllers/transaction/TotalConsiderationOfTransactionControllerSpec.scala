...
class TotalConsiderationOfTransactionControllerSpec extends SpecBase with MockitoSugar {
  ...
  "TotalConsiderationOfTransaction Controller" - {
    ...
    // TODO DTR-2942 tr-5a add test for invalid VAT included in total consideration validation when implemented
...
//        .set(VatIncludedInTotalConsiderationPage, "10").success.value
//      
//      val application = applicationBuilder(userAnswers = Some(userAnswers)).build()
//
//      running(application) {
...
//    }
    ...
    // TODO DTR-2956 tr-7a add test for invalid total consideration of linked transaction when implemented
