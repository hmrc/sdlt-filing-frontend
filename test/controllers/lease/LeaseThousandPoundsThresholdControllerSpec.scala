...
class LeaseThousandPoundsThresholdControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val leaseThousandPoundsThresholdRoute = controllers.lease.routes.LeaseThousandPoundsThresholdController.onPageLoad(NormalMode).url
  ...
  "LeaseThousandPoundsThreshold Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(LeaseThousandPoundsThresholdPage, true).success.value
