...
class VendorAgentsReferenceControllerSpec extends SpecBase with MockitoSugar {
  ...
  val userAnswersWithAgentReferenceKnown:UserAnswers = emptyUserAnswers.copy(
    data = Json.obj(
  ...
  val userAnswersWithAgentReferenceUnknown:UserAnswers = emptyUserAnswers.copy(
    data = Json.obj(
      "vendorCurrent" -> Json.obj(
        "whoIsTheVendor" -> "Business",
        "agentName" -> "test",
  ...
  val userAnswersWithoutAgentReferenceEmptyAnswer: UserAnswers = emptyUserAnswers.copy(
    data = Json.obj(
      "vendorCurrent" -> Json.obj(
        "whoIsTheVendor" -> "Business",
        "agentName" -> "test"
  ...
  val userAnswersWithoutAgentName:UserAnswers = emptyUserAnswers.copy(
    data = Json.obj(
      "vendorCurrent" -> Json.obj(
      "whoIsTheVendor" -> "Business"
      )
