(function() {
    ...
    var displayNonUKResident = function(data) {
        if(data === undefined) return false;
        return (data.propertyType === 'Residential' &&
    ...
    var displayOwnedOtherProperties = function(data) {
        if(data === undefined) return false;
        return (data.propertyType === 'Residential' && data.individual === 'Yes' && data.twoOrMoreProperties == 'No' && validator.effectiveDateWithinFTBRange(data.effectiveDate) && (validator.effectiveDateIsBeforeJuly2020(data.effectiveDate) ||  validator.effectiveDateIsAfterJune2021(data.effectiveDate)));
    };
