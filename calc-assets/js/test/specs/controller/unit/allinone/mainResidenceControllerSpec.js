(function() {
    ...
    describe('Main Residence Controller', function () {
        ...
        describe('Calling .submit() on the Main Residence Controller with invalid data', function () {
        ...
        describe('Calling .submit() on the Main Residence Controller with valid data', function () {
