(function() {
    ...
    describe('Contracts Exchanged Controller', function () {
        ...
        beforeEach(mocks.inject(function ($controller, $rootScope) {
            ...
            controller = $controller('exchangeContractsController', {
                $scope : mockScope,
                $location : {},
                dataService : mockDataService,
                exchangeContractsValidationService : mockValidationService,
        ...
        describe('Calling .submit() on the Contracts Exchanged Controller with invalid data', function () {
        ...
        describe('Calling .submit() on the Contracts Exchanged Controller with valid Yes Yes data', function () {
        ...
        describe('Calling .submit() on the Contracts Exchanged Controller with valid No data', function () {
        ...
        describe('Calling .submit() on the Contracts Exchanged Controller with valid Yes No data', function () {
