(function() {
    ...
    describe('First Time Buyer Controller', function () {
        ...
        describe('Calling .submit() on the First Time Buyer Controller with invalid data', function () {
        ...
        describe('Calling .submit() on the First Time Buyer Controller with valid data', function () {
