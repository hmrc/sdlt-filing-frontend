(function() {
    ...
    describe('Holding Controller', function () {
        ...
        describe('Calling .submit() on the Holding Controller with invalid data', function () {
        ...
        describe('Calling .submit() on the Holding Controller with valid data', function () {
