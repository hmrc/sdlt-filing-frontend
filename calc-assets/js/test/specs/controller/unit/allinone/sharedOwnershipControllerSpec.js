(function() {
    ...
    describe('Shared Ownership Controller', function () {
        ...
        describe('Calling .submit() on the Shared Ownership Controller with invalid data', function () {
        ...
        describe('Calling .submit() on the Shared Ownership Controller with valid data', function () {
