...
class Navigator @Inject()() {
  ...
  private def transactionRoutes(page: Page): UserAnswers => Call = page match {
    ...
    case TransactionExercisingAnOptionPage =>
      _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case _ => _ => routes.IndexController.onPageLoad()
  }
  ...
  private val checkRouteMap: Page => UserAnswers => Call = {
    ...
    case IsPurchaserRegisteredWithCISPage                            => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case TransactionCisNumberPage                                    => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case ConsiderationsAffectedUncertainPage                         => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case TransactionDeferringPaymentPage                             => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case TransactionUseOfLandOrPropertyPage                          => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case SaleOfBusinessPage                                          => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case TransactionSaleOfBusinessAssetsPage                         => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case TotalAssetsConsiderationPage                                => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case Cap1OrNsbcPage                                              => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case TransactionRulingFollowedPage                               => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case TransactionRestrictionsCovenantsAndConditionsPage           => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case DescriptionOfRestrictionsPage                               => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
    case IsLandOrPropertyExchangedPage                               => _ => controllers.transaction.routes.TransactionCheckYourAnswersController.onPageLoad()
