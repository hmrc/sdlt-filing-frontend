...
class FrontendAppConfig @Inject() (configuration: Configuration) {
  ...
  val exitSurveyUrl: String    = configuration.get[String]("urls.feedback")
  ...
  lazy val sdltManagementHost: String = configuration.get[String](s"sdlt-management-frontend.host")
  ...
  lazy val businessTaxAccountHost: String = configuration.get[String](s"business-tax-account.host")
