    ...
    answers.get(AddPurchaserAgentReferenceNumberPage).map {
      answer =>
        ...
        SummaryListRowViewModel(
          key = "purchaserAgent.addAgentReferenceNumber.checkYourAnswersLabel",
          value = ValueViewModel(value),
          actions = Seq(
            ActionItemViewModel("site.change", controllers.purchaserAgent.routes.AddPurchaserAgentReferenceNumberController.onPageLoad(CheckMode).url)
