...
import services.pdf.SdltPdfFields._
...
/**
 * Fills the SDLT1 PDF template (pages 1-3) from a [[FullReturn]].
 *
 * All field names come from [[SdltPdfFields]] which was extracted directly
 * from the real SDLT1E (2011) template using PyMuPDF.
 *
 * The filled PDF bytes are returned ready to be merged with any
 * supplementary forms by [[SdltReturnPdfMergeService]].
 */
@Singleton
