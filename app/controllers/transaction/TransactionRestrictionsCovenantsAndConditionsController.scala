...
import pages.transaction.{DescriptionOfRestrictionsPage, TransactionRestrictionsCovenantsAndConditionsPage}
        ...
        value =>
          for {
            ...
            finalAnswers <- Future.fromTry {
              if !value then updatedAnswers.remove(DescriptionOfRestrictionsPage)
