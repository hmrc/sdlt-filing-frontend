        ...
        value =>
          for {
            ...
            if (value) {
              ...
              // TODO: DTR-3483 SPRINT 14 redirect to tr-15 Is any land exchanged or part exchanged?
              Redirect(controllers.transaction.routes.TransactionRestrictionsCovenantsAndConditionsController.onPageLoad(mode))
            }
          }
      )
  }
