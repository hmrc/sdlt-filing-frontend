...
trait ActivatedIdentifierAction extends ActionBuilder[IdentifierRequest, AnyContent] with ActionFunction[Request, IdentifierRequest]

class AuthenticatedActivatedIdentifierAction @Inject()(
                                               override val authConnector: AuthConnector,
                                               config: FrontendAppConfig,
                                               val parser: BodyParsers.Default
                                             )(implicit val executionContext: ExecutionContext)
  extends ActivatedIdentifierAction with AuthorisedFunctions {
        ...
        sdltEnrol match {
          case Some(enrol) =>
            ...
            if(enrol.isActivated){
              ...
              Future.successful(Redirect(controllers.submission.routes.SubmissionAccountNotActivatedController.onPageLoad()))
            }
          case None =>
...
class SessionActivatedIdentifierAction @Inject()(
                                         val parser: BodyParsers.Default
                                       )(implicit val executionContext: ExecutionContext) extends ActivatedIdentifierAction {
