...
class LeaseEndDateController @Inject()(
                                        ...
                                        formProvider: LeaseEndDateFormProvider,
                                        val controllerComponents: MessagesControllerComponents,
                                        leaseDatesService: LeaseDatesService,
                                        view: LeaseEndDateView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(LeaseEndDatePage) match {
        case None => form
