...
object LeaseholdSliceRatesTables {
  ...
  val leaseholdMixedOrNonResidentialMar16OnwardsLeasePremRates: SliceTable = SliceTable(
    slices = Seq(
      Slice(from = 0,      to = Some(150000), rate = 0),
      Slice(from = 150000, to = Some(250000), rate = 2),
      Slice(from = 250000, to = None,         rate = 5)
  ...
  val leaseHoldResidentialFirstTimeBuyerReliefAfterNov2017AndBeforeJul20PremiumRates: SliceTable = SliceTable(
    slices = Seq(
      Slice(from = 0,        to = Some(125000),   rate = 0),
      Slice(from = 125000,   to = Some(250000),   rate = 2),
      Slice(from = 250000,   to = Some(925000),   rate = 5),
  ...
  val leaseHoldResidentialFirstTimeBuyerReliefAfterNov2017AndBeforeJul20NPVRates: SliceTable = SliceTable(
    slices = Seq(
      Slice(from = 0,        to = Some(125000),   rate = 0),
      Slice(from = 125000,   to = None,           rate = 1)
    )
