...
object Dates {
  ...
  val MAR2010_RESIDENTIAL_DATE: LocalDate = LocalDate.of(2010, 3, 25)
  val MAR2012_RESIDENTIAL_DATE: LocalDate = LocalDate.of(2012, 3, 25)
  val MAR_22_2012_RESIDENTIAL_DATE: LocalDate = LocalDate.of(2012, 3, 22)
  ...
  val MAR2017_EFFECTIVE_DATE: LocalDate = LocalDate.of(2017, 3, 17)
  ...
  val JUNE2021_RESIDENTIAL_DATE: LocalDate = LocalDate.of(2021, 6, 30)
  val JULY2021_RESIDENTIAL_DATE: LocalDate = LocalDate.of(2021, 7, 1)
  val SEPT2021_RESIDENTIAL_DATE: LocalDate = LocalDate.of(2021, 9, 30)
  val SEPT2022_RESIDENTIAL_DATE: LocalDate = LocalDate.of(2022, 9, 23)
  val APRIL2025_RESIDENTIAL_DATE: LocalDate = LocalDate.of(2025, 4, 1)
  val OCT2024_RESIDENTIAL_DATE: LocalDate = LocalDate.of(2024, 10, 31)
 }
