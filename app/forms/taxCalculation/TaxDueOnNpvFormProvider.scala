  ...
  def apply(): Form[String] =
    Form(
      "value" -> wholeNumberCurrency(
        requiredKey = "taxCalculation.taxDueOnNpv.error.required",
        invalidNumericKey = "taxCalculation.taxDueOnNpv.error.invalidNumeric",
        invalidWholeNumberKey = "taxCalculation.taxDueOnNpv.error.invalidWholeNumber",
