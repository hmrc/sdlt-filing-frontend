...
class LeaseStartingRentEndDateFormProvider @Inject() () extends Mappings {
  ...
  def apply()(implicit messages: Messages): Form[LocalDate] =
    Form(
      "value" -> localDate(
        invalidKey     = "lease.leaseStartingRentEndDate.error.invalid",
        allRequiredKey = "lease.leaseStartingRentEndDate.error.required.all",
