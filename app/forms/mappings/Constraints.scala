...
trait Constraints {
  ...
  protected def localAuthorityCodeConstraints(effectiveTransactionDate: Option[LocalDate], contractEffDate: Option[LocalDate], postcode: String, errorKey: String): Constraint[String] = Constraint {
    ...
    code =>
      ...
      val welshLocalAuthNumbers = "^((6805)|(6810)|(6815)|(6820)|(6825)|(6828)|(6829)|(6830)|(6835)|(6840)|(6845)|(6850)|(6853)|(6854)|(6855)|(6905)|(6910)|(6915)|(6920)|(6925)|(6930)|(6935)|(6940)|(6945)|(6950)|(6955)){0,4}$"
