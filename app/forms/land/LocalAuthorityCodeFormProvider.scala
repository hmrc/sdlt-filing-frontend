  ...
  def apply(): Form[String] = Form(
    "value" -> text("land.localAuthorityCode.error.required")
      .verifying(firstError(
        ...
        regexp("^[0-9]{4}$",       "land.localAuthorityCode.error.invalidChars"),
        regexp(authorityCodeRegex, "land.localAuthorityCode.constraint.invalid")
      ))
  )
}