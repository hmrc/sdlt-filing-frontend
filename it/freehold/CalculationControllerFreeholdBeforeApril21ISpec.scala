  ...
  "Hitting the /calculate route" should {
    ...
    "return a 200 and valid result for freehold property type" when {
      ...
      "the effective date is JUL 2017" when {
        ...
        "residential, Individual && notTwoOrMoreProperties, JUL 2017" in{
          def request: WSResponse = ws.url(
            calculateUrl)
            .post(
              Json.parse(
        ...
        "residential, Individual && notTwoOrMoreProperties, FTB, NOV 2017" in{
          def request: WSResponse = ws.url(
            calculateUrl)
            .post(
              Json.parse(
        ...
        "non-residential, notIndividual, JUL 2017" in{
          def request: WSResponse = ws.url(
            calculateUrl)
            .post(
              Json.parse(
