...
class CalculationControllerLeaseholdOct21ISpec extends UnitSpec with GuiceOneServerPerSuite {
      ...
      "the effective date is OCT 1 2021" when {
        ...
        "the purchasers are all UK resident" when {
          ...
          """.stripMargin)
            ...
            "residential, Additional Property premium < 40K" in {
              def request: WSResponse = ws.url(
                calculateUrl)
                .post(
                  Json.parse(
            ...
            "residential, Additional Property, less than 7y lease" in {
              def request: WSResponse = ws.url(
                calculateUrl)
                .post(
                  Json.parse(
          ...
          """.stripMargin)
            ...
            "residential, Additional Property, less than 7y lease, rent < 1000" in {
              def request: WSResponse = ws.url(
                calculateUrl)
                .post(
                  Json.parse(
          ...
          """.stripMargin)
            ...
            "residential, Additional Property, Rent < 100K" in {
              def request: WSResponse = ws.url(
                calculateUrl)
                .post(
                  Json.parse(
        ...
        "one or more purchasers are non-UK resident" when {
          ...
          """.stripMargin)
            ...
            "residential 500K Premium + < 7yr lease" in {
              def request: WSResponse = ws.url(
                calculateUrl)
                .post(
                  Json.parse(
          ...
          """.stripMargin)
            ...
            "residential Premium < 40K + Rent < 1K" in {
              def request: WSResponse = ws.url(
                calculateUrl)
                .post(
                  Json.parse(
          ...
          """.stripMargin)
            ...
            "residential Premium < 40K + HRAD" in {
              def request: WSResponse = ws.url(
                calculateUrl)
                .post(
                  Json.parse(
            ...
            "residential Premium < 40K + HRAD + less than 7y lease" in {
              def request: WSResponse = ws.url(
                calculateUrl)
                .post(
                  Json.parse(
          ...
          """.stripMargin)
            ...
            "residential Premium < 40K + HRAD + less than 7y lease + rent < 1000" in {
              def request: WSResponse = ws.url(
                calculateUrl)
                .post(
                  Json.parse(
          ...
          """.stripMargin)
            ...
            "residential Premium < 40K + HRAD + Rent < 1000" in {
              def request: WSResponse = ws.url(
                calculateUrl)
                .post(
                  Json.parse(
