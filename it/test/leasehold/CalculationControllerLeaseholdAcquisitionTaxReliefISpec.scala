...
class CalculationControllerLeaseholdAcquisitionTaxReliefISpec extends BaseSpec with GuiceOneServerPerSuite {
  ...
  "Hitting the /calculate route" should {
    ...
    "return a 200 and valid result for lease property type" when {
