(function() {
    ...
    describe('Purchase Price Controller', function () {
        ...
        beforeEach(mocks.inject(function ($controller, $rootScope) {
            ...
            controller = $controller('purchasePriceController', {
                ...
                purchasePriceValidationService : mockValidationService,
        ...
        describe('Calling .submit() on the Purchase Price Controller with invalid data', function () {
        ...
        describe('Calling .submit() on the Purchase Price Controller with valid data', function () {
